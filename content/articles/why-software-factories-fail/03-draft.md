...
我真正想说的是：模型存在一个短板。没有相当程度的人类引导，它们无法长期维持并提升代码库质量。[4](https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/main/wsff.md#user-content-fn-3-f56fe9a973fe7c6ebb6a9673c1bc64cb)
...
顺带一提，也许未来某个模型就是能彻底搞定这件事，让我们从此高枕无忧。如果你想无视「苦涩的教训」，一路用提示词豪赌到 GPT-7 发布，看看结果如何，请自便——但我们眼下还有问题要解决，接下来我会说明我们是怎么做的。
