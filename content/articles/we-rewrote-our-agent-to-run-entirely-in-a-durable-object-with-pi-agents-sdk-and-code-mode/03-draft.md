# 我们重写了智能体：借助 Pi、Agents SDK 和 Code Mode，让它完全运行在 Durable Object 中
...
仔细看看智能体实际用 bash 做什么，你会发现放弃它的代价比想象中更低。绝大多数操作都与文件有关，而智能体已经拥有相应的原生工具。我们为它提供读取、写入和编辑工具，再加上自己实现的 [grep 和 glob](https://github.com/qaml-ai/camelAI/blob/main/workers/main/src/pi-container-tools.ts)，这就覆盖了 80% 的主要需求。剩下的是针对特定任务的特定命令，我们把它们改造成了显式方法：
