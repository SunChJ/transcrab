...
[Clone the Repo ↗](https://github.com/lavinigam-gcp/build-with-adk/tree/main/adk-agent-skills-tutorial)
...
We’ve covered skills that exist — skills you write yourself (inline, file-based) or find in community repos (external). We’ve wired them into a `SkillToolset` and seen multi-skill loading in action. This tutorial is part of the [full Agent Engineering series](https://lavinigam.com/series/agent-engineering/) by [Lavi Nigam](https://lavinigam.com/about/) — see [more on ADK](https://lavinigam.com/tags/adk/) for related posts.
